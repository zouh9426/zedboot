...
When both pass, report to me: the zedboot install path, the uiweft detection result, and one confirmation line — "zedboot is installed; say 'Initialize this project from scratch with zedboot' or 'Retrofit this old project with zedboot' in your project to begin."
